...
class firstTreeScenes(Scene):
    ...
    def left_rotate_step(self, x, albero):
        ...
        if x.p == None:
            ...
            ((y).lne).add_updater(lambda m: m.put_start_and_end_on(y.get_center(),(y.p).get_center()))
            self.add(y.lne)
            ...
            ((x).lne).add_updater(lambda m: m.put_start_and_end_on(x.get_center(),(x.p).get_center()))
            self.add(x.lne)
            ...
            ((x.l).lne).add_updater(lambda m: m.put_start_and_end_on((x.l).get_center(),((x.l).p).get_center()))
            self.add((x.l).lne)
            self.play((x.l).animate.move_to((x.l).pos))
            (x.l).pos = (x.l).get_center()
            self.wait(1)
            #here
            #((y.l).lne).remove_updater()
            #x.r = y.l #subtree B (y.left) becomes x's right soon
            (x.r).p = x
            #(x.r).lne = always_redraw(lambda: Line((x.r).get_center(), ((x.r).p).get_center(), buff=RAD))
            ((x.r).lne).add_updater(lambda m: m.put_start_and_end_on((x.r).get_center(),((x.r).p).get_center()))
            self.add((x.r).lne)
    ...
    def insert(self, val, albero):
        ...
        if y == None:
            ...
            (node.r).p = node
            albero.returnTree(node)
            (((node).l).lne).add_updater(lambda m: m.put_start_and_end_on((node.l).get_center(),((node.l).p).get_center()))
            (((node).r).lne).add_updater(lambda m: m.put_start_and_end_on((node.r).get_center(),((node.r).p).get_center()))
            ...
            self.remove(y.l)
            y.l = node
            #((y.l).lne).add_updater(lambda m: m.put_start_and_end_on(node.get_center(),(node.p).get_center()))
            (y.l).l = Node("Nil")
            ((y.l).l).color = 0
            (y.l).r = Node("Nil")
            ((y.l).r).color = 0
            #(((y.l).l).lne).add_updater(lambda m: m.put_start_and_end_on(((y.l).l).get_center(),(((y.l).l).p).get_center()))
            #(((y.l).r).lne).add_updater(lambda m: m.put_start_and_end_on(((y.l).r).get_center(),(((y.l).r).p).get_center()))
            albero.returnTree(y)
            ...
            self.remove(y.r)
            y.r = node
            #((y.r).lne).add_updater(lambda m: m.put_start_and_end_on((node).get_center(),(node.p).get_center()))
            (y.r).l = Node("Nil")
            ((y.r).l).color = 0
            (y.r).r = Node("Nil")
            ((y.r).r).color = 0
            #(((y.l).r).lne).add_updater(lambda m: m.put_start_and_end_on(((y.r).l).get_center(),(((y.r).l).p).get_center()))
            #(((y.l).r).lne).add_updater(lambda m: m.put_start_and_end_on(((y.r).r).get_center(),(((y.r).r).p).get_center()))
            albero.returnTree(y)
            self.play((y.r).animate.move_to((y.r).pos))
            albero.returnTree(y.r)
